-- Mirrors migrations_pg/044_run_triage.sql (Postgres).
...
ALTER TABLE workflow_runs ADD COLUMN triage_state TEXT;
ALTER TABLE workflow_runs ADD COLUMN triage_note  TEXT;
ALTER TABLE workflow_runs ADD COLUMN triaged_at   TEXT;
-- Who decided. Email rather than id: the point of this column is to be readable
-- months later, when the account may be gone.
ALTER TABLE workflow_runs ADD COLUMN triaged_by   TEXT;
